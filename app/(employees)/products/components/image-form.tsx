...
import { updateProductImageAction } from "../actions"; // You can define this like updateProductAction
import {
  type UpdateProductImageSchema,
...
export const ImageForm = ({ id, src }: Props) => {
  ...
  const { form, action } = useHookFormAction(
    ...
    zodResolver(updateProductImageSchema),
    {
      formProps: {
        mode: "onChange",
        defaultValues: {
  ...
  const onSubmit = (e: React.FormEvent) => {
    ...
    const formData: UpdateProductImageSchema = {
      id,
      image,
    };
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground text-sm">
          Manage and update the product image below. You can preview new uploads
          before saving.
        </p>
      </div>
