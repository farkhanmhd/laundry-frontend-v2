...
export const columns: ColumnDef<Voucher>[] = [
  {
    ...
    cell: ({ row }) => <div className='line-clamp-1 min-w-max font-medium uppercase'>{row.getValue("id")}</div>,
  },
  {
    accessorKey: "code",
    header: ({ column }) => <DataTableColumnHeader column={column} title='Code' />,
    cell: ({ row }) => <div className='line-clamp-1 min-w-max font-medium uppercase'>{row.getValue("code")}</div>,
  },
  {
    accessorKey: "name",
  ...
  },
  {
    ...
    cell: ({ row }) => <div className='line-clamp-1 min-w-max font-medium'>{row.getValue("discountAmount")}</div>,
  },
  {
    accessorKey: "pointsCost",
    header: ({ column }) => <DataTableColumnHeader column={column} title='Discount' />,
    cell: ({ row }) => <div className='line-clamp-1 min-w-max font-medium'>{row.getValue("pointsCost")}</div>,
  },
  {
