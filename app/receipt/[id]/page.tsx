...
// ---------------------------------------------------------------------------
// Each section is wrapped independently:
//   <SectionErrorBoundary>        — catches fetch/render errors per section
//     <Suspense fallback={...}>   — shows skeleton while the async component streams in
//       <AsyncSectionComponent /> — RSC that awaits its own fetch
//     </Suspense>
//   </SectionErrorBoundary>
//
// Because all sections are siblings rendered at the same time, their fetches
// run in parallel — no section blocks another.
// ---------------------------------------------------------------------------
