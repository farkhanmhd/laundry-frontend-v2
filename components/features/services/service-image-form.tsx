...
import { updateServiceImageAction } from "@/lib/modules/services/actions";
import {
  type UpdateServiceImageSchema,
...
export const ServiceImageForm = ({ id, src }: Props) => {
  ...
  const { form, action } = useHookFormAction(
    ...
    zodResolver(updateServiceImageSchema),
    {
      formProps: {
        mode: "onChange",
        defaultValues: {
  ...
  const onSubmit = (e: React.FormEvent) => {
    ...
    const formData: UpdateServiceImageSchema = {
      id,
      image,
    };
