  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden bg-background h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
...
function SidebarMenuSkeleton({
  ...
  return (
    <div
      ...
      className={cn("flex h-8 items-center gap-2 rounded-md px-2 md:flex-col", className)}
      {...props}
    >
      {showIcon && (
        <Skeleton
          className="md:size-5 rounded-md"
          data-sidebar="menu-skeleton-icon"
        />
      )}
      <Skeleton
        className=" max-w-(--skeleton-width) flex-1 md:w-15 md:h-0.5"
